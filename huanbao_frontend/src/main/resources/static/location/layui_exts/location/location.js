layui.define(['layer','locationX'], function (exports) {
	...
	var tpl0 = '<div class="cur-load0"></div>\n' +
            ...
            '    <button id="ew-map-select-btn-ok" class="layui-btn icon-btn pull-right" type="button"><i class="layui-icon">&#xe605;</i>确定\n' +
            '    </button>\n' +
            '</div>\n' +
                ...
                var index = layer.open({
                    ...
                    success: function () {
                        ...
                        if (undefined === window.BMap) {
                            $.getScript("http://api.map.baidu.com/getscript?v=2.0&ak=K4RGTdiZafc6TYSWLA266hagVd1PO7P2&services=&t=20200824135534", function () {
                                o.openBaiduMap();
                            });
                        } else {
                            o.openBaiduMap();
