...
public final class ToolString implements Serializable {
	...
	*/
	...
	/**
	 * 生成时间格式:yyyy-MM-dd HH:mm:ss,不能到static关键字!!!
	 * @作者 田应平
	 * @返回值类型 String
	...
	*/
	public static boolean deleFileByRealPath(final HttpServletRequest request,final String webImageUrl){
		...
		final boolean flagRealImagePath = deleFileByRealPath(realImagePath);//删除原图片
		final boolean flagRealImageResizedPath = deleFileByRealPath(realImageResizedPath);//删除压缩图片
